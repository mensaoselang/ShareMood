...
import com.example.sharemood.utils.UtilHelpers;
...
public abstract class BaseActivity<P extends XPresent> extends XActivity<P> implements TakePhoto.TakeResultListener, InvokeListener {
    //设置状态栏
